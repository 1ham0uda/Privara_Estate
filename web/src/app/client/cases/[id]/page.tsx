    ...
    return (
      <div className="min-h-screen bg-gray-50" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <main className="max-w-md mx-auto px-4 py-20 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">{t('client.case.not_found_title')}</h1>
          <p className="text-gray-500 mb-6">{t('client.case.not_found_desc')}</p>
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6 mb-5 sm:mb-6">
                <div>
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    ...
                    <span className="text-sm text-gray-400">{t('client.case.case_number')} #{consultation.id.slice(-6)}</span>
                  </div>
              ...
              <div className="mt-2">
                <div className="flex items-center justify-between gap-3 mb-3 sm:hidden">
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900 mt-1">{t(`case.stage.${consultation.stage}`)}</p>
                  </div>
            ...
            <section>
              <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
                <FileText className="w-5 h-5 text-gray-400" /> {t('client.case.intake_information')}
              </h2>
                ...
                <Card className="p-6 border-none shadow-sm" hover={false}>
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase font-bold">{t('client.case.goal')}</p>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase font-bold">{t('client.case.preferred_area')}</p>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase font-bold">{t('client.case.budget_range')}</p>
                ...
                <Card className="p-6 border-none shadow-sm" hover={false}>
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase font-bold">{t('client.case.property_type')}</p>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 uppercase font-bold">{t('client.case.delivery_time')}</p>
                    ...
                    {consultation.intake.projectsInMind && (
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-xs text-gray-400 uppercase font-bold">{t('client.case.projects_in_mind')}</p>
              ...
              {consultation.intake.notes && (
                <Card className="mt-4 p-6 border-none shadow-sm" hover={false}>
                  <p className="text-xs text-gray-400 uppercase font-bold mb-2">{t('client.case.additional_notes')}</p>
              ...
              {consultant ? (
                <Card className="p-6 border-none shadow-sm" hover={false}>
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-500 mb-4">{consultant.experienceYears} {t('client.case.years_experience')}</p>
