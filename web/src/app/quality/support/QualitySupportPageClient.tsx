...
type QualitySupportPageClientProps = {
  initialTicketId?: string | null;
};

export default function QualitySupportPageClient({ initialTicketId = null }: QualitySupportPageClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <SupportWorkspace role="quality" initialTicketId={initialTicketId} />
      </main>
    </div>
  );
}
