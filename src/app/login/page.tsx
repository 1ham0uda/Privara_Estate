  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === 'auth/operation-not-allowed') {
        toast.error('Email/Password login is not enabled in Firebase Console. Please enable it or use Google Sign-in.');
      } else {
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <Card className="py-8 px-4 sm:px-10 shadow-xl border-none" hover={false}>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to Privately?</span>
              </div>
            </div>
        ...
        <div className="mt-6 bg-blue-50 p-4 rounded-xl flex items-start gap-3">
          ...
          <div className="text-sm text-blue-700 text-left">
            ...
            <p>Admin: admin@privately.com / admin123</p>
            <p>Consultant: consultant@privately.com / consultant123</p>
          </div>
        </div>
      </div>
    </div>
